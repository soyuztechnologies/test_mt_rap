CLASS lsc_zmt_ab_travel DEFINITION INHERITING FROM cl_abap_behavior_saver.
...
CLASS lsc_zmt_ab_travel IMPLEMENTATION.
...
CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    data: lt_failed type table FOR  FAILED zmt_ab_travel.
    ...
    types:  t_entity_create type table for create zmt_ab_travel,
              t_entity_update TYPE table for update zmt_ab_travel,
              t_entity_rep type table for REPORTED zmt_ab_travel,
              t_entity_err type table for FAILED zmt_ab_travel.
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_authorizations.
    ...
    READ ENTITIES OF zmt_ab_travel in LOCAL MODE
        ENTITY travel
    ...
    loop at lt_travel into data(ls_travel).
        ...
        if ( ls_travel-OverallStatus = 'X' ).
            ...
            AUTHORITY-CHECK OBJECT 'ZMTAB_MGR'
            ID 'ACTVT' FIELD '03'.
  ...
  METHOD earlynumbering_create.
    ...
    data: entity type STRUCTURE FOR CREATE zmt_ab_travel,
...
*        CATCH cx_number_ranges.
  ...
  METHOD copyTravel.
    ...
    data: travels type table for create zmt_ab_travel\\Travel,
          bookings_cba type table for create zmt_ab_travel\\Travel\_Booking,
          booksuppl_cba type table for create zmt_ab_travel\\Booking\_BookingSupplement.
    ...
    MODIFY ENTITIES OF zmt_ab_travel IN LOCAL MODE
        ENTITY travel
