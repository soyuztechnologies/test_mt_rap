CLASS zmt_ab_data_builder DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zmt_ab_data_builder IMPLEMENTATION.
...
*        output =
  ...
  METHOD fill_master_data.
    data : lt_bp type table of zmt_ab_bpa,
           lt_prod type table of zmt_ab_product.
   ...
   append value #(
    ...
    append value #(
     ...
     insert zmt_ab_bpa from table @lt_bp.
     insert zmt_ab_product from table @lt_prod.
  ENDMETHOD.
  ...
  METHOD fill_transaction_data.
    data : o_rand type REF TO cl_abap_random_int,
           ...
           lv_ord_id type zmt_ab_dte_id,
           lt_so type table of zmt_ab_so_hdr,
           lt_so_i type table of zmt_ab_so_item.
    ...
    select * from zmt_ab_bpa into table @data(lt_bpa).
    select * from zmt_ab_product into table @data(lt_prod).
    ...
    insert zmt_ab_so_hdr from table @lt_so.
    insert zmt_ab_so_item from table @lt_so_i.

  ENDMETHOD.

  METHOD flush.
    delete from : zmt_ab_bpa, zmt_ab_product, zmt_ab_so_hdr, zmt_ab_so_item.
  ENDMETHOD.
